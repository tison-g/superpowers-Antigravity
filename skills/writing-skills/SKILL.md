...
```yaml
# ‚ù?BAD: Summarizes workflow - Claude may follow this instead of reading skill
...
- ‚ú?Good: `**REQUIRED SUB-SKILL:** Use test-driven-development`
- ‚ú?Good: `**REQUIRED BACKGROUND:** You MUST understand systematic-debugging`
