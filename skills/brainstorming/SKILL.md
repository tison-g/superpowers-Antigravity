...
5. **Write design doc** â€?save to `.agents/docs/plans/YYYY-MM-DD-<topic>-design.md` and commit
...
**Documentation:**
- Write the validated design to `.agents/docs/plans/YYYY-MM-DD-<topic>-design.md`
